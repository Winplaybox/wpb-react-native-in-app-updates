package com.winplaybox.rninappupdates;
...
@ReactModule(name = wpbreactnativeinappupdatesModule.NAME)
public class wpbreactnativeinappupdatesModule extends ReactContextBaseJavaModule implements InstallStateUpdatedListener, ActivityEventListener {
    public static final String NAME = "WpbInAppUpdates";
    ...
    public wpbreactnativeinappupdatesModule(ReactApplicationContext reactContext) {
        super(reactContext);
